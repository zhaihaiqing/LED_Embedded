...
#define MLED_THREAD_PRIORITY         9			//线程优先级，按键扫描为最高优先级
...
#define CODEC_THREAD_PRIORITY         11			//线程优先级，按键扫描为最高优先级
...
#define SW_THREAD_PRIORITY         12			//线程优先级，按键扫描为最高优先级
...
#define OLED_THREAD_PRIORITY         13			//线程优先级，按键扫描为最高优先级
...
#define ADC_THREAD_PRIORITY         14			//线程优先级，按键扫描为最高优先级
...
#define BOARD_TEMP_THREAD_PRIORITY         15			//线程优先级，按键扫描为最高优先级
